...
//                 <h6>configure how and when you receieve system notifications</h6>
//           </div>
...
//           <label htmlFor="">Edit Email</label> <br />
//           <input type="text" placeholder='Michael Chen@robotec.com' />
//           <div className="my-button">
//             <div className="btn-1">cancel</div>
...
//           <label htmlFor="">Edit Phone</label> <br />
//           <input type="text" placeholder='+234 (555) 123-4567' />
//           <div className="my-button">
//             <div className="btn-1">cancel</div>
//             <div className="btn-2">save changes</div>
